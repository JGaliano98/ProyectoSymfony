 ...
 */
final class Version20240403182445 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE alumno_asignatura DROP FOREIGN KEY FK_996F1A27FC28E5EE');
        $this->addSql('ALTER TABLE alumno_asignatura DROP FOREIGN KEY FK_996F1A27C5C70C5B');
